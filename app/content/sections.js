// ─────────────────────────────────────────────────────────────────────────────
// SHARED CONTENT SECTIONS — single source of truth.
// These render both inside the homepage tabs (ContentTabs.js) and on their own
// routes (/this-week, /venues, /genres, /guide, /musicians). Edit here once and
// both places update.
//
// Keep these as plain function components: no "use client", no async, no
// server-only APIs. They have to work in both a client and a server tree.
// ─────────────────────────────────────────────────────────────────────────────
...
export function VenueGuideSection() {
  return (
    <section style={S.sec}>
      ...
      <p style={S.p}>
        <strong style={S.b}>Pietro&rsquo;s Prime</strong> (125 W Market St) is the upscale end of the strip — a steakhouse with live entertainment Wednesday through Saturday, generally 7–10pm and later on Saturdays. <strong style={S.b}>Station 142</strong> (142 E Market St) is the closest thing West Chester has to a purpose-built music venue: an intimate stage, a real sound system, two bars, and rooftop dining, with local and regional acts Thursday through Saturday plus a well-attended Thursday open mic that provides a house band and full PA.
      </p>
      <p style={S.p}>
        <strong style={S.b}>Brickette Lounge</strong> (3 W Gay St) runs line dancing most weeknights and live country and western on weekends, with a BBQ menu and a 21+ policy after 5pm. <strong style={S.b}>Slow Hand Food &amp; Drink</strong> (30 N Church St) occupies a historic firehouse and books local bands and solo artists Fridays and Saturdays. <strong style={S.b}>Square Bar</strong> (250 E Chestnut St) has been the neighborhood dive for seventy years and still books weekend live music. <strong style={S.b}>Saloon 151</strong> (151 W Gay St) leans on whiskey, Friday karaoke, Wednesday music bingo, and Tuesday Quizzo rather than booked bands.
      </p>

      <h3 style={S.h3o}>Pocono Lake, PA (18347)</h3>
      <p style={S.p}>
        The Pocono lakes region runs a summer-weighted schedule that thins out in winter. <strong style={S.b}>Nick&rsquo;s Lakehouse</strong> is the waterfront option, with live music and an outdoor season that runs hard from Memorial Day through Labor Day. <strong style={S.b}>Boulder View Tavern</strong> and <strong style={S.b}>Murph&rsquo;s Hideaway</strong> are the year-round local rooms — hearty food, regular weekend bookings, and crowds that mix residents with vacation renters. <strong style={S.b}>Jubilee</strong> rounds out the area for live music and dining. In a resort area like this, calling ahead matters more than usual: schedules swing hard with the season and the weather.
      </p>

      <h3 style={S.h3o}>Philadelphia, PA — Commodore John Barry Arts and Cultural Center</h3>
      <p style={S.p}>
        6815 Emlen Street in Mt. Airy, generally known as the Irish Center. It is the region&rsquo;s anchor for Irish and Celtic music, hosting touring performers from Ireland, traditional sessions, céilí dances, and cultural programming year-round, and it is open to the public rather than members-only. Nathan Carter performs October 30th — general admission $50, with meet-and-greet packages available. Full calendar at <A href="https://theirishcenter.org/irish-center-events-calendar/">theirishcenter.org</A>.
      </p>

      <h3 style={S.h3o}>Chicago, IL — Bubb City</h3>
      <p style={S.p}>
        435 North Dearborn Street. Chicago&rsquo;s country music bar and concert venue, drawing large crowds for honky-tonk nights and booked performances in the middle of River North.
      </p>

      <h3 style={S.h3}>Live Music Across the US</h3>
      <p style={S.p}>
        <strong style={S.b}>Los Angeles:</strong> Sunset Strip rock clubs remain the historic draw, but the current scene is spread across Silver Lake rooftops, Echo Park bars, and small acoustic rooms in Santa Monica. Shows start late by national standards — a 9pm door often means an 11pm headliner.
      </p>
      <p style={S.p}>
        <strong style={S.b}>Miami:</strong> Latin music dominates, with live salsa, son, and timba in Little Havana, experimental and hip-hop programming in Wynwood, and hotel-bar jazz across South Beach. Many venues run free dance lessons before the band starts.
      </p>
      <p style={S.p}>
        <strong style={S.b}>Dallas:</strong> Deep Ellum is the historic core — the neighborhood where Blind Lemon Jefferson and Robert Johnson recorded — and still carries blues, country, rock, and jazz across a walkable cluster of clubs.
      </p>
      <p style={S.p}>
        <strong style={S.b}>Seattle:</strong> The grunge legacy gets the attention, but the working scene is indie rock, jazz, and folk across Capitol Hill, Ballard, and Belltown, with an unusually strong all-ages venue tradition.
      </p>
      <p style={S.p}>
        <strong style={S.b}>Nashville, New Orleans, and Austin</strong> are the three cities where live music happens at a scale that makes planning almost unnecessary — Broadway, Frenchmen Street, and Red River respectively will all have multiple bands playing within a block of each other on any given night, most with no cover.
      </p>
    </section>
  );
}
...
export function GenresSection() {
  return (
    <section style={S.sec}>
      ...
      <p style={S.p}>
        The search tool filters by fourteen cultural traditions. Genre labels can be slippery in a live setting — a band billed as &ldquo;Americana&rdquo; might be closer to bluegrass or closer to rock depending on who&rsquo;s in the room — so the descriptions below cover what each tradition actually sounds and feels like live, and what kind of venue tends to host it.
      </p>
      {GENRES.map((g) => (
        <div key={g.name}>
      ...
      <p style={S.p}>
        A large share of live music at neighborhood bars and restaurants is cover material, and there is nothing lesser about it — cover bands are how most working musicians earn a living, and a good one reads a room better than almost anyone. Tribute acts are a related but distinct category, recreating a specific artist&rsquo;s catalog and often their staging. If you specifically want original material, look for listings that say &ldquo;original music,&rdquo; &ldquo;songwriter,&rdquo; or &ldquo;album release,&rdquo; which is how venues signal it.
      </p>
    </section>
  );
}
...
export function LiveMusic101Section() {
  return (
    <section style={S.sec}>
...
export function ForMusiciansSection() {
  return (
    <section style={S.sec}>
      ...
      <h3 style={S.h3}>Get Your Venue or Band Listed</h3>
      <p style={S.p}>
        BBK Music Seeker welcomes submissions from venue owners, promoters, and musicians. Venue owners can submit through the Request a Venue form — featured venues receive a dedicated card in search results with weekly schedule information, automatic performer lookup, and community vibe ratings. Musicians and bands can use the Get Your Band Listed form to appear as highlighted artists. Both forms are inside the search tool on the <a href="/" style={S.a}>home page</a>. Venues that publish a structured public events calendar can have their listings refreshed automatically.
      </p>

...
export default function App() {
  ...
  // NEW: fetch schedule for a venue using the /api/schedule route
                  ...
                  {localVenues.map((v,vi)=>{
                    ...
                    return (
                      <div key={vi} style={{background:"#f8fafc",borderRadius:14,padding:"14px 16px",marginBottom:10,border:"1px solid #e2e8f0",borderLeft:`4px solid ${sc}`}}>
                        ...
                        {/* Auto-found events (from initial venue load via APIFlash) */}
                        ...
                        {/* Scanned events (from manual Scan Site button) */}
